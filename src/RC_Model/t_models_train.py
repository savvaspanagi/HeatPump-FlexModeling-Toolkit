...
from .t_model_simulate import *

def train_greybox_t_model(train_df, model_type, bounds, deltaT, solver_name="ipopt", num_trials=20, show_plot=False, log=True):
    ...
    for i in range(num_trials):
        ...
        try:
            ...
            model, parameters = build_greybox_t_model(
                train_df=train_df,
...
def train_greybox_t_model_with_validation_process(train_df, val_df, model_type, bounds, deltaT, solver_name="ipopt", num_trials=10, show_plot=False, log=True):
